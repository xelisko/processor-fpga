...
set rc [catch {
  ...
  set_property ip_repo_paths c:/DSL4/dsl4_demo_app/dsl4_demo_app.cache/ip [current_project]
  set_property ip_output_repo c:/DSL4/dsl4_demo_app/dsl4_demo_app.cache/ip [current_project]
  add_files -quiet C:/DSL4/dsl4_demo_app/dsl4_demo_app.runs/synth_1/TOP.dcp
